...
def format_message(prefix: str, i: int) -> str:
    """Return the message string used by the talker; pure function suitable for unit testing."""
    return f"{prefix} {i}"
...
class MinimalPublisher(Node):
    ...
    def timer_callback(self):
        msg = String()
        msg.data = format_message(self.msg_prefix, self.i)
